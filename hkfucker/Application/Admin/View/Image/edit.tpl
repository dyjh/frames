    ...
    <div  class=".table-responsive" style="margin:0 5%;width: 20%;">
        <form action=" " method="post"  enctype="multipart/form-data" onsubmit="return cheack_form()">
            ...
            <div class="input-group" style="margin-bottom: 20px;">
                ...
                <select name="model" id="id" style="height:30px; ">
                    <volist name="data_page" id="val">
                        <if condition="$data['model'] eq $val['name']">
                            <option value="{$val.name}" selected>{$val.ch}</option>
                        </if>
                    </volist>
                </select>
            </div>
            <div class="input-group" style="margin-bottom: 20px;">
                ...
                <input type="hidden" name="old_img" value="{$data.url}"/>
