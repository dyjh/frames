...
<block name="content">
    ...
    <div class="page-header">
        <h1>待操作用户<small><a href="{:U('Back/conf',array('type'=>'all'))}">全部处理</a></small></h1>
    </div>
    ...
    <div class="col-md-9 col-md-offset-1 col-xs-8 col-xs-offset-1" >
        <span class="field-validation-valid" data-valmsg-for="sel">当前等级用户量为{$count}</span>
        ...
        <nav aria-label="Page navigation">
            <ul class="pagination" ">
                <li>
                    <a href="{:U('Back/level',array('o'=>$o-1,'p'=>$p,'level'=>$level))}" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a>
                </li>
            <for start="$start" end="$end">
                    <if condition="$o eq $i">
                        <li class="active">
                            <a href="{:U('Back/level',array('o'=>$o-1,'p'=>$p,'level'=>$level))}">{$i}</a>
                        </li>
                        <else/>
                        <li>
                            <a href="{:U('Back/level',array('o'=>$i,'p'=>$p,'level'=>$level))}">{$i}</a>
                        </li>
                    </if>
                </for>
                <li>
                    <a href="{:U('Back/level',array('o'=>$o+1,'p'=>$p,'level'=>$level))}" aria-label="Next"><span aria-hidden="true">&raquo;</span></a>
                </li>
            </ul>
        </nav>
        </if>
    ...
    <div class="col-md-9 col-md-offset-1 col-xs-8 col-xs-offset-1" >
        ...
        <if condition="$state_p eq 0">
            ...
            <nav aria-label="Page navigation">
                <ul class="pagination" ">
                <li>
                    <a href="{:U('Back/level',array('p'=>$p-1,'o'=>$o))}" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a>
                </li>
                <for start="$start_p" end="$end_p">
                    <if condition="$p eq $i">
                        <li class="active">
                            <a href="{:U('Back/level',array('p'=>$p-1,'o'=>$o))}">{$i}</a>
                        </li>
                        <else/>
                        <li>
                            <a href="{:U('Back/level',array('p'=>$i,'o'=>$o))}">{$i}</a>
                        </li>
                    </if>
                </for>
                <li>
                    <a href="{:U('Back/level',array('p'=>$p+1,'o'=>$o))}" aria-label="Next"><span aria-hidden="true">&raquo;</span></a>
                </li>
                </ul>
            </nav>
        </if>
