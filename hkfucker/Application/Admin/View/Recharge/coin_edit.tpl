...
<block name="content">
    ...
    <div  class=".table-responsive" style="margin:0 5%;">
        <form action="{:U('Recharge/coin_edit')}" method="post"  enctype="multipart/form-data">
			...
			<div class="input-group" style="margin-bottom: 20px;">
                <span class="input-group-addon" id="basic-addon1">扣除金币</span>
                <input type="text" name="coin" class="form-control" aria-describedby="basic-addon1" style="width:15%;" value="0">
            </div>
			
			<div class="input-group" style="margin-bottom: 20px;">                
                <input type="checkbox" name="can_cash"   value="1">同时扣除可提现金币
            </div>
