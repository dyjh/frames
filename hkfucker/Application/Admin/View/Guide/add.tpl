    ...
    <div class=".table-responsive">
        <form action="" method="post" enctype="multipart/form-data" onsubmit="">
            ...
            <div class="input-group" id="input_title" style="width: 90%;margin-left: 5%; margin-right: 5%;">
                ...
                <input type="text" class="form-control" placeholder="标题" name="title" value="" aria-describedby="basic-addon1"/>
            </div>
            <div class="input-group" style="width: 90%;margin-left: 5%; margin-right: 5%;">
                <span class="input-group-addon" id="basic-addon1">内容</span>
                <textarea id="tid" name="content"  class="form-control" style=" resize : none;height: 300px;"></textarea>
            </div>
