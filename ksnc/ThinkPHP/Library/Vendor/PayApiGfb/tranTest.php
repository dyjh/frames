...
<form method="POST" action="sign.php">
	<table>
		...
		<tr>
			<td>商户代码:</td>
			<td><input type="text" id="merchantID" name="merchantID" value="0000001502" size="50"/></td>
		</tr>
		<tr>
		...
		<tr>
			<td>国付宝转入账户:</td>
			<td><input type="text" id="virCardNoIn" name="virCardNoIn" value="0000000002000000257" size="50"/></td>
		</tr>
		<tr>
			<td>用户浏览器IP:</td>
		...
		<tr>
			<td>银行代码:</td>
			<td><input type="text" id="bankCode" name="bankCode" value="" size="50"/></td>
		</tr>
		<tr>
			<td>用户类型:</td>
