<?php
require_once("shunfoo/ClassShunfoo.php");
?>
...
<head>
	...
	<script language="javascript" src="'.VENDOR_PATH.'PayApi/php/js/jquery.js"></script>
	<script language="javascript" src="'.VENDOR_PATH.'PayApi/php/'.VENDOR_PATH.'PayApi/php/js/pay.js"></script>
</head>
<body>
<center>

	<?php
	$html	 = '<form method="post" action="'.VENDOR_PATH.'PayApi/php/pay_go.php"  name="pay" id="pay">';
	$html	.= '<div class="pay_base_info">';
	$html	.= '<table class="form">';
	$html	.= '<tbody>';
	$html	.= '<tr class="title">';
	$html	.= '	<td colspan="2"><img src="images/jk_logo.gif" /><br/>phpshunfoo demo 2.0 <br/>银泰接口版本:v2.6<br/>网银支付版本:v1.2</td>';
	$html	.= '</tr>';
	$html	.= '<tr>';
