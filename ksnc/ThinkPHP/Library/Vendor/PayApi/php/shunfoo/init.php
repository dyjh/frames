...
$shunfoo_banktype	= array(
		array('name' => '中国银行', 'code' => '963'),
		array('name' => '中国农业银行', 'code' => '964'),
		array('name' => '中国建设银行', 'code' => '965'),
		array('name' => '中国工商银行', 'code' => '966'),
		array('name' => '招商银行', 'code' => '970'),
		array('name' => '平安银行', 'code' => '978'),
		array('name' => '民生银行', 'code' => '980'),
		array('name' => '交通银行', 'code' => '981'),
		array('name' => '邮政银行', 'code' => '971'),
);

$shunfoo_banktype_three = array(
		array('name' => '支付宝', 'code' => '992'),
		array('name' => '扫码支付', 'code' => '9999'),
		array('name' => '微信', 'code' => '1004')
);

$shunfoo_banktype_remix = array(
		array('name' => '网银汇款充值', 'code' => '2001'),
);

$banktype_now_support = array_merge($shunfoo_banktype,$shunfoo_banktype_three,$shunfoo_banktype_remix);

foreach($banktype_now_support as $key=>$val){
	$shunfoo_banktype_now_support[$val['code']] = $val['name'];
}

//卡限制范围，下面的卡限制范围由银泰约定，请不要轻易修改
