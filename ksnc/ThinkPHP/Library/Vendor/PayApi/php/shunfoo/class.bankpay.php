...
class bankpay{
	...
	* 993  财付通网银支付接口URL
	*/
	const shunfoo_bank_url	= 'http://pay.initepay.com/Bank/';
	...
	*/
	public function send(){
		...
		//
		$url = "parter=". $this->parter ."&bank=". $this->type ."&value=". $this->value. "&orderid=". $this->orderid ."&callbackurl=". $this->callbackurl;
		//签名
