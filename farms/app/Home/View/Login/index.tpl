...
<js file="__JS__/md5.js"/>



<script src="__JS__/login.js?v={:rand(1000,9000)}"></script>
<script src="__JS__/code.js?v={:rand(1000,9000)}"></script>



<link rel="stylesheet" type="text/css" href="__CSS__/login.css?v={:rand(1000,9999)}"/>
		...
		<div class="box">
					...
					<div class="login_box">
						<div class="accounts">
							...
							<div class="accounts_pass">
								<input type="text" name="user" id="login_username" value="{$cook_user}" AutoComplete="off">
							</div>
						</div>
						<div class="password_box">
							...
							<div class="password_pass">
							   <!--新加-->
							   <if condition="$cook_pass neq ''" >
									<input id="login_password" type="password" value="凯撒农场用户"  autocomplete="new-password"/>
								  <else/>
								    <input id="login_password" type="password" value="" autocomplete="new-password"/>
							   </if>	   						
							</div>
							<input type="hidden" name="password"  value="{$cook_pass}" />
						</div>
						<div class="account_box">
							<div class="account" onclick="record('account')">
							    <if condition="$cook_user neq ''" >
								    <img style="display:block" src="__PUBLIC__/Home/images/login/xz.png">
									<input type="hidden" id="record_account" value="1"/>
								<else/>
							        <img src="__PUBLIC__/Home/images/login/xz.png">
									<input type="hidden" id="record_account" value="0"/>
							    </if> 
							</div>
							<div class="password" onclick="record('password')">
								...
								<else/>
								    <img src="__PUBLIC__/Home/images/login/xz.png">
									<input type="hidden" id="record_password" value="0"/>
								</if>
							</div>
						</div>
						...
						<div class="login_footer">
							<div class="lg_box">
								<div class="et_nber">
									{$number['first_number']} + {$number['secord_number']} = &nbsp;?
								</div>
								<div class="enter_box">
									<for start="0" end="3">
										 <if condition="$confuse_number[$i] eq $_SESSION['login_number']" ><div class="enter_game">{$confuse_number[$i]}</div>
											  <else/><div class="et_error">{$confuse_number[$i]}</div>
										 </if>		
				...
				<form id="reset_form" action="" method="post">
					...
					<div class="alert_success">
						...
						<div class="success_rompt" id="success">
							   <img src="__PUBLIC__/Home/images/login/fanghui.png">
						</div>
						 </div>
					...
					<div class="register_box">
						...
						<div class="verification_code">
							...
							<div class="prompt_input prompt_input2">
						        <div class="verification_img"><img id="img_code" width="100%" height="90%" src="{:U('Login/yzm')}" onclick="this.src='<?php echo U("Login/yzm")?>?r='+Math.random()"/></div>
			...
			<div class="firm_img">
				<div class="firm_box" style="margin-left: 10%">
					<a href="{:U('Certificate/index')}?Certificate_type=1" target="_blank">
						<img src="__PUBLIC__/Home/images/login/icp_icon.png">
					</a>
				</div>
				<div class="firm_box">
					<a href="{:U('Certificate/index')}?Certificate_type=2" target="_blank">
						<img src="__PUBLIC__/Home/images/login/gs_icon.png">
					</a>
				</div>
				<div class="firm_box">
					<a href="{:U('Certificate/index')}?Certificate_type=3" target="_blank">
						<img src="__PUBLIC__/Home/images/login/cultrue_icon.png">
					</a>
				</div>
				<div class="firm_box">
					<a href="{:U('Certificate/index')}?Certificate_type=4" target="_blank">
						<img src="__PUBLIC__/Home/images/login/copyrights.png">
					</a>
				</div>
				<div class="firm_box" style="margin-left: 21%;width: 23%;">
					<a href="{:U('Certificate/index')}?Certificate_type=5" target="_blank">
						<img src="/farms/Public/Home/images/login/silver.png" style="margin-top: 3.5%;">
					</a>
				</div>
				<div class="firm_box" style="margin-left: 10%;width: 23%;">
					<a href="{:U('Certificate/index')}?Certificate_type=6" target="_blank">
