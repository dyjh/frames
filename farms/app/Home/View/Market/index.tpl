		...
		<div class="tradingcenter_box">
			<div class="tradingcenter">
				<foreach name="data" item="v" >
					 <a href="{:U('Market/pay')}?id={$v['id']}"><div class="trading_body">
							<div class="data_list" style="margin-left: 6%">
									<div class="data_classify"><span id="unit_{$key}">正在获取...</span></div>
									<div class="data_classify" style="margin-top: 2%"><span id="rise_{$key}">正在获取...</span></div>
									<div class="trading_fruits">
										<img src="__PUBLIC__/Home/images/market/{$v['img_name']}.png">
									</div>
									<div class="trading_titlefruits"><span>{$v['varieties']}</span></div>
							</div>
						</div></a>
			  </foreach>	
			</div>
		</div>
		<a href="{:U('Index/index')}"><div class="tradingcenter_returna tradingcenter_return"></div></a>
	</div>
</div>
</body>
</html>
